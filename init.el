...
(custom-set-variables
 ...
 '(flymake-proc-allowed-file-name-masks
   '(("\\.py\\'" flymake-pyflakes-init) ("\\.cs\\'" flymake-simple-make-init)
     ("\\.p[ml]\\'" flymake-perl-init) ("\\.php[345]?\\'" flymake-php-init)
     ("\\.h\\'" flymake-master-make-header-init flymake-master-cleanup)
     ("\\.java\\'" flymake-simple-make-java-init flymake-simple-java-cleanup)
     ("[0-9]+\\.tex\\'" flymake-master-tex-init flymake-master-cleanup)
     ("\\.tex\\'" flymake-simple-tex-init) ("\\.idl\\'" flymake-simple-make-init)))
 ...
 '(org-structure-template-alist
   '(("s" "#+BEGIN_SRC ?\12\12#+END_SRC" "<src lang=\"?\">\12\12</src>")
     ...
     ("a" "#+BEGIN_ASCII\12?\12#+END_ASCII" "") ("A" "#+ASCII: " "") ("i" "#+INDEX: ?" "#+INDEX: ?")
     ("I" "#+INCLUDE: %file ?" "<include file=%file markup=\"?\">")))
 '(package-selected-packages
   '(## ac-inf-ruby ace-jump-mode ag async avy bazel cask copilot dash editorconfig elm-mode erlang
	eslint-fix exec-path-from-shell expand-region f find-file-in-repository flx flx-ido flycheck
	flymake-go flymake-ruby git-commit go-autocomplete go-complete go-guru go-mode go-playground
	go-snippets gotest groovy-mode haskell-mode hcl-mode hexrgb indium inf-ruby jedi jedi-core
	jedi-direx js2-mode kubed lsp-mode lsp-pyright lua-mode magit magit-popup package-build
	pallet php-mode prettier-js projectile protobuf-mode puppet-mode pyenv-mode pyenv-mode-auto
	quelpa quelpa-leaf quelpa-use-package reformatter rg robe rust-mode rustic rvm
	terraform-mode tide transient tree-sitter tree-sitter-langs tsc use-package vcl-mode
	web-mode which-key with-editor xref-js2 yaml-mode yasnippet))
